...
GRANT ALL ON TABLE public."draft_registrations" TO anon;
GRANT ALL ON TABLE public."draft_registrations" TO authenticated;
GRANT ALL ON TABLE public."draft_registrations" TO service_role;
